        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li>
                        <a href="students.jsp"><i class="fa fa-fw fa-table"></i>View Students</a>
                    </li>
...
<div class="form-group">
    <label for="student-title">Enrollment_no.</label>
        <input type="number" name="student_enroll" class="form-control">
       
    </div>
	
<div class="form-group">
    <label for="student-title">Name</label>
...
<div class="form-group">
 ...
 <div class="form-group">
         <label for="student-semester">Semester</label>
          <hr>
        <select name="student_semester" id="" class="form-control">
